...
const guides = [
  ...
  },
  {
    ...
    additionalImages: [
      ...
      "https://images.unsplash.com/photo-1517713982677-4b66332f0f36?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
...
type AdventureType = keyof typeof adventureIcons;
...
export default function GuidesPage() {
  ...
  const handleProfileClick = (guide: Guide) => {
    setSelectedGuide(guide)
                ...
                <div className="flex flex-wrap gap-2">
                  {guide.adventureTypes.slice(0, 3).map((type, index) => (
                    <Badge key={index} variant="outline">
                      {adventureIcons[type as AdventureType] || null}
