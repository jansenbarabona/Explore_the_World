...
const generateMockPosts = (count:number) => {
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      images: [
        `https://images.unsplash.com/photo-1453899242646-c74d86b5b8e8?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max&s=2d0bd4cef8c2955243273764ca953dcf`,
